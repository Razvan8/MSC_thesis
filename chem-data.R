...
Y <- y.all      # dataframe with 3955 yield values and rows having names of the form "addi i : aryl j : base k : liga l" 
head(Y)

X <- xxxx.all   # design matrix 3955 x 3959 with rows relative to combination (ijkl) and columns of the form c(addi, ..., liga, addi:base, ..., addi:aryl:base:liga) 
head(X[,1:25])
